...
function getQuickPostFeedLabels(dict: Awaited<ReturnType<typeof getDictionary>>) {
  return {
    ...
    recurrenceStartDate: dict.quickPost.recurrenceStartDate,
    recurrenceEndDate: dict.quickPost.recurrenceEndDate,
    recurrenceDays: dict.quickPost.recurrenceDays,
    weekdaysShort: dict.quickPost.weekdaysShort,
    weekdaysLong: dict.quickPost.weekdaysLong,
