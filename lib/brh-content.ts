...
export const about: LocalizedText = {
  id: [
    "Assoc. Prof. Budi Rahman Hakim, S.Ag., M.S.W., Ph.D. adalah akademisi, penulis, jurnalis senior, dan pembina spiritual yang bergerak di persimpangan antara studi Islam, tasawuf, kesejahteraan sosial, media, dan pembangunan peradaban. Ia merupakan Associate Professor di UIN Syarif Hidayatullah Jakarta, wartawan senior Rakyat Merdeka Media Group, serta pendiri dan pengasuh Pesantren Peradaban Dunia JAGAT 'ARSY di BSD Serpong, Tangerang Selatan.",
  ...
  en: [
    "Assoc. Prof. Budi Rahman Hakim, S.Ag., M.S.W., Ph.D. is an academic, author, senior journalist, and spiritual mentor working at the intersection of Islamic studies, Sufism, social welfare, media, and civilizational development. He is an Associate Professor at UIN Syarif Hidayatullah Jakarta, a senior journalist at Rakyat Merdeka Media Group, and the founder and caregiver of JAGAT 'ARSY Civilization Boarding School in BSD Serpong, South Tangerang, Indonesia.",
