...
export const about: LocalizedText = {
  id: [
    "Budi Rahman Hakim, S.Ag., M.S.W., Ph.D. adalah akademisi, penulis, jurnalis senior, dan pembina spiritual yang bergerak di persimpangan antara studi Islam, tasawuf, kesejahteraan sosial, media, dan pembangunan peradaban. Ia merupakan Associate Professor di UIN Syarif Hidayatullah Jakarta, wartawan senior Rakyat Merdeka Media Group, serta pendiri dan pengasuh Pesantren Peradaban Dunia JAGAT 'ARSY di BSD Serpong, Tangerang Selatan.",
