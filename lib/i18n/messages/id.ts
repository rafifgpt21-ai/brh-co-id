export const dictionary = {
  ...
  home: {
    ...
    highlightEyebrow: "PILIHAN KURATOR",
    highlightTitleA: "Karya",
    highlightTitleB: "Pilihan",
    latestEyebrow: "ARSIP INTELEKTUAL",
    latestTitleA: "Latest",
    latestTitleB: "Update",
    latestShort: "Terbaru",
  ...
  quickPost: {
    ...
    teaching: "Pengajaran",
    engagement: "Pengabdian",
    agendaCategory: "Jenis Agenda",
    agendaCategoryRequired: "Pilih jenis agenda Pengajaran atau Pengabdian.",
    ...
    sourceArticle: "Dari artikel",
    readSource: "Baca artikel",
    publish: "Publish",
    draft: "Draft",
    posting: "Menyimpan...",
    ...
    allTitle: "Agenda & Kutipan BRH",
    allIntro:
      "Kumpulan agenda Pengajaran, Pengabdian, dan kutipan terbaru dari BRH Insight.",
    ...
    scheduleMode: "Pola Jadwal",
    scheduleSingle: "Satu Kali",
    scheduleRecurring: "Berulang",
    recurrenceStartDate: "Dari tanggal",
    recurrenceEndDate: "Sampai tanggal",
    recurrenceDays: "Berulang setiap",
    weekdaysShort: ["Min", "Sen", "Sel", "Rab", "Kam", "Jum", "Sab"],
    weekdaysLong: ["Minggu", "Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu"],
    recurrenceHint: "Pilih rentang tanggal dan hari pelaksanaan.",
    recurrenceSummary: "{count} agenda akan dibuat sekaligus.",
    recurrenceRequired: "Lengkapi rentang tanggal dan pilih minimal satu hari.",
    recurrenceInvalidRange: "Tanggal akhir harus sama dengan atau setelah tanggal mulai.",
    recurrenceRangeTooLong: "Rentang jadwal maksimal 2 tahun.",
    recurrenceTooMany: "Maksimal 200 agenda dalam sekali posting.",
    recurrenceNoDates: "Tidak ada hari terpilih di dalam rentang tanggal ini.",
    successRecurring: "{count} agenda berhasil disimpan.",
    agendaLink: "Tautan Pengajaran (opsional)",
    agendaLinkPlaceholder: "https://contoh.com/materi-atau-kelas",
    agendaLinkHint: "Tombol menuju tautan ini akan tampil pada kartu agenda Pengajaran.",
    openTeachingLink: "Buka Tautan Pengajaran",
